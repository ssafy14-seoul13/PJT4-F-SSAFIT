...
-- 2. 비디오 더미 데이터
INSERT INTO video (id, title, part, url, view_cnt, regist_id)
VALUES
(1, '2주만에 복근 만드는 운동 2 MIN ABS WORKOUT', '복근', 'https://www.youtube.com/watch?v=PoYzxj8Iy5M', 0, 'thankyou123'),
(2, '전신 다이어트 최고의 운동 [칼소폭 마라맛🔥]', '전신', 'https://www.youtube.com/watch?v=F-Jd4kI6rdM', 0, 'thankyou123'),
(3, '5분! 팔뚝살 빨리빼는운동 / 상체 다이어트 [팔뚝살 마라맛🔥]', '상체', 'https://www.youtube.com/watch?v=MEzTdtFdfbI', 0, 'thankyou123');

-- 3. 리뷰 더미 데이터
INSERT INTO review (title, writer, content, view_cnt, video_id)
VALUES
('복근 운동 후기', '김싸피', '정말 효과 좋네요! 2주 만에 복근이 보입니다.', 0, 1),
('전신 운동 최고', 'FitnessFan', '칼소폭 마라맛이라고 해서 기대했는데 정말 힘들지만 재미있어요.', 0, 2),
('팔뚝살 감소 성공', '박싸피', '5분만에 팔뚝살이 눈에 띄게 줄었어요!', 0, 3);
